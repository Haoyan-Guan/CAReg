...
class FSAD_Dataset_train(Dataset):
    def __init__(self,
        ...
        assert class_name in CLASS_NAMES_MVTec, 'class_name: {}, should be in {}'.format(class_name, CLASS_NAMES_MVTec)
    ...
    def shuffle_dataset(self):
        ...
        for class_name_one in CLASS_NAMES_MVTec:
...
class FSAD_all_Dataset_train(Dataset):
    #train all classes
    def __init__(self,
                 dataset_path='../data/mvtec_anomaly_detection',
                 class_name='bottle',
        ...
        #assert class_name in CLASS_NAMES_MVTec, 'class_name: {}, should be in {}'.format(class_name, CLASS_NAMES_MVTec)
        self.dataset_path = dataset_path
        if 'MVTec' in dataset_path:
            self.CLASS_NAMES = CLASS_NAMES_MVTec
        elif 'MPDD' in dataset_path:
            self.CLASS_NAMES = CLASS_NAMES_MPDD
        else:
            print('No CLASS_NAMES Found')
...
class FSAD_Dataset_test(Dataset):
    def __init__(self,
        ...
        #assert class_name in CLASS_NAMES_MPDD, 'class_name: {}, should be in {}'.format(class_name, CLASS_NAMES_MPDD)
        self.dataset_path = dataset_path
        self.class_name = class_name
        self.is_train = is_train
        self.resize = resize
